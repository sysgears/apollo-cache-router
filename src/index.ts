...
class LogCache<TCache> extends ApolloCache<TCache> {
  private cache: ApolloCache<TCache>;
...
export const log = <TCache>(cache: ApolloCache<TCache>, options?: LogOptions): ApolloCache<TCache> =>
  new LogCache(cache, options);
